...
const SketchesPage = () => {
  ...
  const categories = [
    ...
    { id: 'figure', label: 'Figure Studies' },
    ...
    <>
      ...
      <section className="pt-32 pb-12 px-4">
        <div className="container mx-auto">
          <h1 className="text-4xl md:text-5xl font-playfair text-center mb-2">Sketches</h1>
          <p className="text-center text-zaph-cream/80 max-w-2xl mx-auto mb-12">
            Capturing the essence and beauty of the human form through traditional media.
          </p>
      ...
      <section className="pb-24 px-4">
        <div className="container mx-auto">
          <SketchGallery items={sketches} category={activeCategory || undefined} />
        </div>
      </section>
